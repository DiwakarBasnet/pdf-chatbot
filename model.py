...
class ChatModel:
    def __init__(self, model_id: str="google/gemma-2b-it", device="cpu"):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(model_id, cache_dir=CACHE_DIR, token=ACCESS_TOKEN)
    ...
    def generate(self, question: str, context: str = None, max_new_tokens = 250):
